...
public class TestNGCustomReport implements IReporter {
    ...
    protected void writeHead() {
        writer.print("<head>");
        writer.print("<title>Remedy Automation Report</title>");
        writeStylesheet();
        writer.print("</head>");
    }
...
//writer.print(".skippedeven td {background-color: #CCC}");
    ...
    protected void writeBody() {
        ...
        writer.print("<body>");
        writeReportTitle("Remedy Automation Report");
        writeProjectDetails();
        writeSuiteSummary();
    ...
    protected void writeProjectDetails() {
        ...
        writer.print("<td> "+ SystemProperties.BUILD_URL+"Remedy_Automation_5fAutomation_5fReport/" +" </td>");
        writer.print("</tr>");
        ...
        writer.print("<td> "+ SystemProperties.REMEDY_URL +" </td>");
        writer.print("</tr>");
        writer.print("<tr>");
