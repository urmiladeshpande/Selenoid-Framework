...
public interface SystemProperties {
  ...
  //  public static final String AUTOMATE_ACCESS_KEY = "kxcLz1kAScjLqRpxyPro";
    ...
    String USERNAME = System.getProperty("Username","abhinav.kumar@mnghealth.com");
    String PASSWORD = System.getProperty("Password","abhi@1234");
   ...
   // String REMOTE_URL = getProperty("remote.url", "http://54.226.11.199:4444/wd/hub");
    ...
    String REMEDY_URL =System.getProperty("URL", "https://test-engage.mnghealth.com/commD/Login");
